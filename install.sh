...
# =============================================================
# 🚀 TERMUX ULTRA BEAUTY — ไร้กรอบ ตรงเป๊ะ 100%
#    โดย Captaineieiei — ไม่มีเส้นให้เอียง!
# =============================================================

clear

# ── ใช้ echo พร้อมสี ANSI โดยตรง ──
echo ""
...
# ──── STARTUP BANNER (ไร้กรอบ ตรงเป๊ะ) ────
clear
echo ""
echo -e "\033[1;36m          ████████╗███████╗██████╗ ███╗   ███╗██╗   ██╗██╗  ██╗\033[0m"
echo -e "\033[1;36m          ╚══██╔══╝██╔════╝██╔══██╗████╗ ████║██║   ██║╚██╗██╔╝\033[0m"
...
echo -e "\033[1;32m|                                                      |\033[0m"
echo -e "\033[1;32m|   🎉 ติดตั้งเสร็จสมบูรณ์! (ไร้กรอบ ตรงเป๊ะ)         |\033[0m"
echo -e "\033[1;32m|                                                      |\033[0m"
...
echo -e "\033[1;32m|      ✅ Startup Banner สวย (ไร้กรอบ)                |\033[0m"
